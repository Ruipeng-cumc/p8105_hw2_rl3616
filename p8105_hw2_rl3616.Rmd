...
#### Little question
Should I delete all the temporary data(like jan2020_df, zips_in_zori) and only leave the main data(like dfs. final_wheels, new_york_zori) in the environment?
Thank you so much!
